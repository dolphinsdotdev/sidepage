...
- [x] Hardware gating is an allowlist (`cpu-*`), not a denylist — a tier that doesn't exist yet fails closed. Verified live: `cpu-basic`/`cpu-upgrade`/`cpu-xl` runnable, `zero-a10g` refused
